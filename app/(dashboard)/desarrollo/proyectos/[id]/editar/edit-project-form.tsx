        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="0"
              disabled={isPending}
              defaultValue={project.stdReservationAmount ?? ''}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="20"
              disabled={isPending}
              defaultValue={project.stdInitialPercent ?? ''}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="40"
              disabled={isPending}
              defaultValue={project.stdConstructionPercent ?? ''}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="40"
              disabled={isPending}
              defaultValue={project.stdFinalPercent ?? ''}
            />
          </div>
        </div>
        <p className="text-xs text-muted-foreground">
